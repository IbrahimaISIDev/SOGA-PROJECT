      ...
      // ── Formations ──────────────────────────────────────────
      {
        ...
        fields: [
          ...
          },
          {
            ...
            name: "niveau",
            label: "Niveau",
            options: ["Technicien Spécialisé", "BTS", "Licence", "Master"],
            required: true,
          },
          {
            type: "string",
          ...
          { type: "string", name: "publicConcerne", label: "Public concerné", ui: { component: "textarea" } },
      ...
      // ── Institution (document unique) ───────────────────────
      {
        ...
        fields: [
          ...
          { type: "string", name: "telephone", label: "Téléphone", required: true },
          {
            ...
            label: "Campus",
            list: true,
            ui: { itemProps: (item) => ({ label: item?.ville }) },
            fields: [
              { type: "string", name: "ville", label: "Ville", required: true },
