...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-soga-dark relative overflow-hidden">
      ...
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-soga-dark via-soga-graphite/20 to-soga-dark" />
      ...
      <div className="relative z-20 w-full max-w-md p-8 animate-fade-in">
        <div className="card p-8">
          ...
          <h1 className="text-3xl font-bold text-center text-soga-gold mb-2">
            SOGA Admin
          </h1>
          <p className="text-soga-muted text-center mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-soga-light text-sm font-medium mb-2">
                Email
              </label>
              <div className="relative">
                <Mail size={20} className="absolute left-3 top-1/2 -translate-y-1/2 text-soga-muted" />
                <input
                  type="email"
                  value={email}
            ...
            <div>
              ...
              <div className="relative">
                <Lock size={20} className="absolute left-3 top-1/2 -translate-y-1/2 text-soga-muted" />
                <input
                  type="password"
                  value={password}
            ...
            >
              {loading ? (
                <>
                  <div className="w-5 h-5 border-2 border-soga-dark border-t-transparent rounded-full animate-spin" />
                  Connexion...
                </>
              ) : (
                'Se connecter'
          ...
          <div className="mt-8 pt-6 border-t border-soga-muted/20 text-center">
            <p className="text-soga-muted text-sm">
              © 2026 SOGA Senegal - Système de Gestion Académique
            </p>
          </div>
        </div>
      </div>
