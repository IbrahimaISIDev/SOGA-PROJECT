...
import { Building2, MapPin, Facebook, Linkedin, Twitter, Save, Sparkles } from 'lucide-react';
...
export default function Institution() {
  ...
  if (isLoading) return <div className="text-soga-light animate-pulse">Chargement...</div>;

  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-soga-light mb-2">Institution</h1>
        <p className="text-soga-muted">
          Gérer les informations de l'institution SOGA
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <div className="card p-6 animate-slide-in" style={{ animationDelay: '0ms' }}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-soga-light">Informations générales</h2>
              </div>
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-soga-dark mb-2">Slogan</label>
                  <input
                    type="text"
            ...
            <div className="card p-6 animate-slide-in" style={{ animationDelay: '100ms' }}>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-soga-gold/10 rounded-lg flex items-center justify-center">
                  <MapPin size={20} className="text-soga-gold" />
                </div>
                <h2 className="text-xl font-semibold text-soga-light">Coordonnées</h2>
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-soga-dark mb-2">Adresse</label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-soga-dark mb-2">Téléphone</label>
                    <input
                      type="text"
          ...
          <div className="space-y-6">
            <div className="card p-6 animate-slide-in" style={{ animationDelay: '200ms' }}>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-soga-gold/10 rounded-lg flex items-center justify-center">
                  <Sparkles size={20} className="text-soga-gold" />
                </div>
                <h2 className="text-xl font-semibold text-soga-light">Réseaux sociaux</h2>
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-soga-dark mb-2 flex items-center gap-2">
            ...
            <div className="card p-6 animate-slide-in" style={{ animationDelay: '300ms' }}>
              <button
                type="submit"
                disabled={mutation.isPending}
                className="w-full px-6 py-4 text-white bg-soga-gold rounded-lg hover:bg-soga-gold-light hover:shadow-lg hover:shadow-soga-gold/30 transition-all duration-200 font-semibold disabled:bg-soga-muted disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                <Save size={20} />
