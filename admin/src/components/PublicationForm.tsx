  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-semibold text-soga-dark mb-2">Auteur</label>
          <input
            type="text"
            name="auteur"
      ...
      <div className="space-y-2">
        <label className="block text-sm font-semibold text-soga-dark mb-2">Fichier URL</label>
        <input
          type="text"
          name="fichier"
