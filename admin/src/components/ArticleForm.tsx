...
export default function ArticleForm({ initialData, onSubmit, onCancel, error, isLoading }: ArticleFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <label className="block text-sm font-semibold text-soga-dark mb-2">Résumé</label>
        <textarea
          name="resume"
      ...
      <div className="space-y-2">
        <label className="block text-sm font-semibold text-soga-dark mb-2">Contenu</label>
        <textarea
          name="contenu"
